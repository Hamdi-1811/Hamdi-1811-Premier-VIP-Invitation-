...
const InvestorVision: React.FC = () => {
    return (
        <Section id="investor-vision" title="" maxWidth="max-w-5xl">
            <div className="investor-highlight p-10 rounded-2xl animated-card">
                ...
                <a href="#registration" className="cta-button-primary px-8 py-3 text-base font-bold tracking-wider uppercase rounded-xl text-white transition-all duration-300">
